<?php /* Smarty version Smarty-3.1.14, created on 2022-12-24 05:46:04
         compiled from "C:\OpenServer\domains\elmarco\elmarcosite\wa-apps\shop\templates\actions\product\Product.html" */ ?>
<?php /*%%SmartyHeaderCode:105155331063a667ece9d871-64967512%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'c4b9fa9f01f5b8deb299aed31e024979023edd7b' => 
    array (
      0 => 'C:\\OpenServer\\domains\\elmarco\\elmarcosite\\wa-apps\\shop\\templates\\actions\\product\\Product.html',
      1 => 1666095286,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '105155331063a667ece9d871-64967512',
  'function' => 
  array (
    'categories_select' => 
    array (
  ...
  'unifunc' => 'content_63a667ed0d1723_34495953',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_63a667ed0d1723_34495953')) {function content_63a667ed0d1723_34495953($_smarty_tpl) {?><?php if (!is_callable('smarty_modifier_replace')) include 'C:\\OpenServer\\domains\\elmarco\\elmarcosite\\wa-system\\vendors\\smarty3\\plugins\\modifier.replace.php';
...
products/<?php if ($_smarty_tpl->tpl_vars['product']->value['id']==='new'){?>new<?php }else{ ?><?php echo htmlspecialchars($_smarty_tpl->tpl_vars['product']->value['id'], ENT_QUOTES, 'UTF-8', true);?>
<?php }?>/"
               href="<?php echo $_smarty_tpl->tpl_vars['wa_app_url']->value;?>
products/<?php if ($_smarty_tpl->tpl_vars['product']->value['id']==='new'){?>new<?php }else{ ?><?php echo htmlspecialchars($_smarty_tpl->tpl_vars['product']->value['id'], ENT_QUOTES, 'UTF-8', true);?>
<?php }?>/"
               title="<?php echo htmlspecialchars(_w("Try out the new products section version. The option to return to the old editor will remain."), ENT_QUOTES, 'UTF-8', true);?>
            ...
            <script>
                ( function($) {
                    ...
                    function leavePage() {
                        ...
                        var text = "<?php echo htmlspecialchars(_w("Your changes will be lost if you do not save them."), ENT_QUOTES, 'UTF-8', true);?>
";
                        if (confirm(text)) {
                            deferred.resolve();
                        } else {
        ...
        <?php }elseif(!($_smarty_tpl->tpl_vars['product']->value['id']==='new'||$_smarty_tpl->tpl_vars['product']->value['status']==="-1")){?>
            <a class="s-new-product-editor-button float-right" style="<?php if ($_smarty_tpl->tpl_vars['product']->value['id']==='new'){?>display: none<?php }?>"
               href="<?php echo $_smarty_tpl->tpl_vars['wa_app_url']->value;?>
products/<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['product']->value['id'], ENT_QUOTES, 'UTF-8', true);?>
/prices/"
               title="<?php echo htmlspecialchars(_w("Try out the new products section version. The option to return to the old editor will remain."), ENT_QUOTES, 'UTF-8', true);?>
">Попробовать новый раздел товаров</a>
        <?php }?>
...
<?php } ?><?php }?>
        ...
        <?php if ($_smarty_tpl->tpl_vars['edit_rights']->value){?>
            <a href="<?php echo htmlspecialchars(shopHelper::getBackendEditorUrl($_smarty_tpl->tpl_vars['product']->value['id']), ENT_QUOTES, 'UTF-8', true);?>
...
" class="<?php if (empty($_smarty_tpl->tpl_vars['sku']->value['available'])||empty($_smarty_tpl->tpl_vars['sku']->value['status'])){?>grey <?php }?><?php if ($_smarty_tpl->tpl_vars['sku']->value['virtual']){?>s-sku-virtual<?php }?>" title="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['sku']->value['sku'], ENT_QUOTES, 'UTF-8', true);?>
">
                                    <td class="s-name">
